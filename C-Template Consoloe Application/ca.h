...
void lifeanddrawnewcleanzoom(CA_RULE *cr,CA_CT *sc,int scsz,int64_t tm,int res,int dyrt,UINT32 *pnv,const UINT32 *pni,int de,caComputationMode cnmd,const unsigned int klrg,caDisplaySettings ds);
...
define CL_MAX_PLATFORM_COUNT(4)#define CL_MAX_DEVICE_COUNT(4)OCLCA OCLCA_Init(const char *cl_filename);
